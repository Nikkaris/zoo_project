...
void TownLocationBuilder::setFriendlyCharacters(){
    FriendlyCharacter* smith = new FriendlyCharacter("Oswald", 5, 99, 3, 50);
    ...
    FriendlyCharacter* weaponSmith = new FriendlyCharacter("Radulfr", 5, 99, 3, 50);
    ...
    FriendlyCharacter* alchemist = new FriendlyCharacter("Yoana", 5, 4, 3, 50);
